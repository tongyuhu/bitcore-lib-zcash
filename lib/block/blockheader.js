...
var BlockHeader = function BlockHeader(arg) {
  ...
  this.genSign = info.genSign;
  this.plotID = info.plotID;
  this.baseTarget = info.baseTarget;
...
BlockHeader._fromObject = function _fromObject(data) {
  ...
  if (_.isString(data.genSign)) {
    genSign = BufferUtil.reverse(new Buffer(data.genSign, 'hex'));
  }
...
BlockHeader._fromBufferReader = function _fromBufferReader(br) {
  ...
  info.genSign      = br.read(32);
  info.plotID       = br.readUInt64LEBN();
  info.baseTarget   = br.readUInt64LEBN();
  info.deadline     = br.readUInt64LEBN();
  return info;
};
...
BlockHeader.prototype.toObject = BlockHeader.prototype.toJSON = function toObject() {
  return {
    ...
    genSign: BufferUtil.reverse(this.genSign).toString('hex'),
    plotID: this.plotID.toString(10),
    baseTarget: this.baseTarget.toString(10),
    deadline: this.deadline.toString(10)
  };
};
...
BlockHeader.prototype.toBufferWriter = function toBufferWriter(bw) {
  ...
  bw.write(this.genSign);
  bw.writeUInt64LEBN(this.plotID);
  bw.writeUInt64LEBN(this.baseTarget);
  bw.writeUInt64LEBN(this.deadline);
  return bw;
};
